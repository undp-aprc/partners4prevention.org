...
<body class="<?php print $body_classes; ?>">
  ...
  <div id="page"><div id="page-inner">
    ...
    <div id="photo-block">
      <?php if ($photo_block): ?>
          <?php print $photo_block; ?>
      <?php endif; ?>
    </div>
    <div id="tagline"></div> <!-- Renders tagline under the photo-block. To change the tagline, overwrite '/themes/partners_for_prevention/gfx/bg_tagline.jpg' -->
    ...
    <div id="main"><div id="main-inner" class="clear-block">
      ...
      <div id="content-area-wrapper"> <!-- To render the whole content background area #fff -->
